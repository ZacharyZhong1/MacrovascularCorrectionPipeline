...
OutputDirGeneral='../Simulated_Signal/R2_MaxfBVSeed/';
InfoDirGeneral='../Simulated_Mask/';
SignalDir='../Max_fBV_Seed/';
...
for Sub=1:5
    ...
    SignalFileName=[SignalDir 'Sub' num2str(Sub) '_MaxfBVSeed.mat'];
    load(SignalFileName);
    NumTime=length(MaxfBVSeed);
    ...
    YveinTC=Yvein+Yvein*0.30*MaxfBVSeed;   % Oxygenated level variation
